...
EXEC smc_SUIDelvInProc 'A', 258, '1\_/', '20241204', 84, '9\_/', '200\_/', @Status OUTPUT, @Results OUTPUT, @DelvSeq OUTPUT

 

 

select @Status,@Results, @DelvSeq

 

 

SELECT \* FROM SMC_TMESImpDelvProclog
